...
export const H7 = [
  ...
  "Make sure not to overload too much!!",
  "Honestly, I think this mental health thing is really overblown. Like if you wanna kill yourself go ahead, but I personally think thats dumb idea considering you have so many more years left to improve whatever situation you find yourself in. People have grown soft in modern times unfortunately.",
  "I wanted to kill myself in first year",
  ...
  "There is no help. The wait time is ridiculous.",
  ...
  "make nice friends and be nice to them",
  ...
  "Easy to isolate yourself and get lonely.",
  ...
  "Chill out a little",
  "Video game addiction led to depression",
...
export const H9 = [
  ...
  "nothing it's on the individual",
  "Stop using the final 50%~100% marking scheme",
  "provide quality services",
  "Why is it the responsibility of a University to accommodate one's mental health? UW should continue to focus on providing good quality education so they don't become the source of one's mental health problems.",
  "Nothing, my mental health was a skill issue/me problem",
  ...
  "my mental health issues were not UW-related",
...
export const H11 = [
  ...
  "Acceptance. We can't all be imposters. Some of us are just actually dumb but that's okay",
  ...
  "i dont have it because im the greatest",
  "Not feeling like I deserved any of my jobs",
  "Other people writes more code a lot better than me and it makes me sad",
  "Grind harder",
  ...
  "Positive. It's a motivation.",
  "Thought I didn't deserve the praise I got",
  "Still struggle with it",
  "You are there imposter",
  "No",
