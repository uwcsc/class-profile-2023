...
export const F2 = [
  ...
  // { text: "Vancouver, British Columbia", value: 2 },

  // { text: "Montreal, Quebec", value: 1 },

  // { text: "Kitchener, Ontario", value: 1 },
  // { text: "Markham, Ontario", value: 1 },
  // { text: "Ottawa, Ontario", value: 1 },
  // { text: "Waterloo, Ontario", value: 3 },
  // { text: "Toronto, Ontario", value: 14 },

  // { text: "Chicago, Illinois", value: 1 },

  // { text: "Cupertino, California", value: 1 },
  // { text: "Bay Area, California", value: 1 },
  // { text: "San Jose, California", value: 1 },
  // { text: "Los Angeles, California", value: 1 },
  // { text: "San Francisco, California", value: 10 },
  // { text: "Sunnyvale, California", value: 1 },
  // { text: "San Mateo, California", value: 4 },
];
...
export const F6 = [
  // G10ii. If you are working outside Canada, what will be your first year total compensation (salary + signing + first year stock + bonus) in CAD?
  { category: "0-50k", value: 1 },
...
export const F7 = [
  // G11. What field/career path will you be in post-grad?
